...
class Doctrine_migration_versions 
{
	...
	{
		return is_null($this->_executed_at)?null:$this->_executed_at->format('Y-n-j');
	}

	public function setExecuted_at(?string $executed_at)
	{
		$this->_executed_at=is_null($executed_at)?null:DateTime::createFromFormat("Y-n-j",$executed_at);
	}

...
echo '<div class="caseListe grid-columns-span-5">Liste des Doctrine_migration_versions </div>';
...
echo '<div class="caseListe">Executed_at</div>';
echo '<div class="caseListe">Execution_time</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getExecuted_at().'</div>';
echo '<div class="caseListe">'.$unObjet->getExecution_time().'</div>';
